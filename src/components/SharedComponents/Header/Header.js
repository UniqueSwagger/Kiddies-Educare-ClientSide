            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
              <div className="relative flex items-center justify-between h-16">
                <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                  {/* Mobile menu button*/}
                  <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-teal-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                ...
                <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                  <div className="flex-shrink-0 flex items-center">
                    {/* logo */}
                    <h1 className="text-2xl font-medium text-white">Kiddies</h1>
                  </div>
                  <div className="hidden sm:block sm:ml-6">
                    <div className="flex space-x-4">
                      ...
                      <NavLink
                        to={"/home"}
                        className=" hover:bg-white hover:text-teal-600 px-3 py-2 rounded-md text-lg font-medium text-gray-800"
                      >
                        Home
                      </NavLink>
                      <NavLink
                ...
                <div className="flex items-center pr-2  sm:ml-6 sm:pr-0 space-x-3 text-gray-300">
                  ...
                  <div className="flex items-center pr-2 sm:ml-6 sm:pr-0 space-x-4">
                    <div className="space-x-4 flex items-center">
                      ...
                      <button className="px-4 py-2 bg-white text-red-600 font-medium rounded-full">
                        Logout
                      </button>
                    </div>
                    <NavLink
                      className="text-white text-xl border-b-2 border-transparent hover:text-orange-400"
            ...
            <Disclosure.Panel className="sm:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1">
                <Disclosure.Button
                  as="a"
                  href="/home"
                  className="text-gray-300 hover:bg-gray-700 hover:text-teal-600 block px-3 py-2 rounded-md text-base font-medium"
                >
                  Home
                </Disclosure.Button>
                <Disclosure.Button
